    ...
    effects: [
      {
        ...
        symbol: '風牙',
        level: [2],
        description: 'Lv2時、攻撃中にデッキの上から2枚をオープン。その中の系統：「風牙」を手札に加え、残りは破棄',
      },
    ],
  },
  ...
  spirit_graipher: {
    ...
    effects: [
      ...
      },
      {
        ...
        level: [2],
        skill: '真界放',
        description: 'Lv2時、攻撃時にデッキの上から3枚をオープン。その中の系統：「風牙」を手札に加え、残りは破棄',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        condition: { excludeEXSymbol: true },
        skill: '継召',
        description: 'Lv1-2時、召喚時に自分のトラッシュの「セルタリウス」以外の系統：「風牙」を持つスピリットカード1枚を手札に戻す',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        level: [1, 2],
        skill: '継召',
        description: 'Lv1-2時、アタック中に自分の手札の系統：「風牙」を持つカード1枚を破棄する。このバトル中、このスピリットをBP+3000する',
      },
      {
        trigger: 'attack',
        action: 'search_deck',
    ...
    effects: [
      {
        ...
        value: 2000,
        level: [1, 2],
        description: 'Lv1-2時、自分のアタックステップにアタックしている系統：「風牙」を持つ自分のスピリット1体をBP+2000する',
      },
      {
        trigger: 'destroy',
        action: 'place_core',
    ...
    effects: [
      {
        ...
        description: 'メイン: 真界放していない相手のネクサス1つを破壊',
      },
      {
        trigger: 'immediate',
        action: 'boost_bp',
    ...
    effects: [
      {
        ...
        target: 'opponent_creature',
        skill: 'ソウルマジック：赤',
        description: 'フラッシュ: BP7000以下の相手のスピリット1体を破壊',
      },
    ],
  },
};
