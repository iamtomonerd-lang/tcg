  ...
  spirit_cubel: {
    ...
    effects: [
      ...
      },
      {
        ...
        requiresTarget: true,
        level: [2],
        condition: { excludeSoulCore: false },
        description: 'Lv2時、自分のエンドステップに系統：「風牙」を持つ自分のスピリット/ネクサス1つを指定できる。自分のトラッシュのソウルコアをそれに置く',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mode: 'flash',
        level: [1, 2],
        description: 'Lv1-2時、アタック中に【起動：フラッシュ】〔ターン1回〕自分の手札の系統：「風牙」を持つカード1枚を破棄する',
      },
      {
        trigger: 'attack',
        action: 'boost_bp',
  ...
  nexus_wind_fang_rock: {
    ...
    effects: [
      ...
      },
      {
        ...
        level: [1],
        targetType: 'attacking',
        description: 'Lv1時、相手のアタック中に【フラッシュ】系統：「風牙」を持つ自分のスピリット1体をこのターン中、BP+2000する',
      },
      {
        trigger: 'destroy',
        action: 'place_core',
    ...
    effects: [
      {
        ...
        requiresTarget: true,
        skill: 'ソウルマジック：赤',
        description: 'フラッシュ: BP7000以下の相手のスピリット1体を指定する。それを破壊する。このターンに自分のライフが減っていたなら、かわりに指定するBPを10000以下にする',
      },
    ],
  },
};
